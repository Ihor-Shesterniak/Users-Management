...
<nav class="navbar navbar-inverse navbar-fixed-top table-responsive">
    <div class="container">
        <div class="navbar-header">
            <buton type="button" class="navbar-toggle collapsed" data-toggle="collapse" data-target="#navbar"
